...
- (void)viewDidLoad {
    ...
    //这句代码是IOS7时 使用的设置毛玻璃效果
//    UIToolbar *toolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(0,0 , self.zoomImageView.frame.size.width, self.zoomImageView.frame.size.height+68)];
//    toolbar.barStyle = UIBarStyleBlackOpaque;//设置毛玻璃样式
//    [self.zoomImageView addSubview:toolbar];
...
//    effectView.frame = CGRectMake(0,0 , self.zoomImageView.frame.size.width, self.zoomImageView.frame.size.height+68);
//    [self.zoomImageView addSubview:effectView];
//    
